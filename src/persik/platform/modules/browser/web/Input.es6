import InputGeneric from '../../generic/InputGeneric';
...
class Input extends InputGeneric {
  ...
  constructor() {
    ...
    this.map[8] = Input.CODE_BACK; // backspace
    this.map[27] = Input.CODE_BACK; // esc
    this.map[13] = Input.CODE_ENTER;
    this.map[73] = Input.CODE_INFO; // i
    this.map[84] = Input.CODE_TOOLS; // t
    this.map[192] = Input.CODE_MENU; // `
    ...
    this.map[109] = Input.CODE_VOLUME_DOWN; // gray -
    this.map[107] = Input.CODE_VOLUME_UP; // gray +
    this.map[189] = Input.CODE_VOLUME_DOWN; // -
    this.map[187] = Input.CODE_VOLUME_UP; // =
